                                    ...
                                    <tr>
                                        <td align="center" style="padding-bottom: 24px;">
                                            <div style="background: rgba(255, 77, 45, 0.06);border: 1px solid rgba(255, 77, 45, 0.25);display: inline-block;padding: 14px 32px;border-radius: 12px;">
                                                <span style="font-family: 'Courier New', Courier, monospace;font-size: 32px;font-weight: 700;color: #ff4d2d;letter-spacing: 6px;padding-left: 6px;">
                                                    ${otp}
                                                </span>
                                            </div>
                                        </td>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 460px; margin-top: 20px;">
                                    <tr>
                                        <td align="center" style="padding-top: 24px;border-top: 1px solid rgba(255,255,255,0.06);">
                                            <p style="margin: 0 0 10px 0;font-size: 12px;line-height: 1.7;color: #71717a;">
                                                ⚠️ <strong>Security Notice:</strong> This is an automated email. Please <strong>do not reply</strong> directly to this message, as replies are not monitored.
                                            </p>

                                            <p style="margin: 0;font-size: 12px;line-height: 1.7;color: #71717a;">
                                                🔒 For your security, never share this verification code, reset link, or account access details with anyone. Vingo administrators will never ask for your password or OTP.
                                            </p>
                                        </td>
                                    </tr>
                                </table>
...
export const sendDeliveryOtpMail = async (user, otp) => {
    try {
        ...
        const info = await transporter.sendMail({
            from: `"Vingo Orders" <${process.env.SMTP_USER}>`,
            to: userEmail,
            subject: "📦 Your Delivery Verification Code — Vingo",
            html: `
                <html>
                    <head>
                        <meta charset="utf-8">
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <table width="100%" id="email-card" border="0" cellspacing="0" cellpadding="0" style=" max-width: 460px;background-color: #18181b;border: 1px solid rgba(255, 255, 255, 0.08);border-radius: 16px;padding: 32px; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.5);">
                                    ...
                                    <tr>
                                        <td align="center" style="padding-bottom: 12px;">
                                            <h2 style="margin: 0;font-size: 20px;font-weight: 600;color: #ffffff;">Delivery Verification</h2>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding-bottom: 28px;">
                                            <p style="margin: 0;font-size: 14px;color: #a1a1aa;line-height: 1.5;">
                                                Please share the following One-Time Password (OTP) with your delivery partner to safely receive your order.
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding-bottom: 24px; border-bottom: 1px solid rgba(255, 255, 255, 0.06);">
                                            <p style="margin: 0;font-size: 13px;color: #4ade80;font-weight: 500;background-color: rgba(74, 222, 128, 0.06); display: inline-block; padding: 4px 12px; border-radius: 6px">
                                                🛵 Arriving Soon
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center" style="padding-top: 24px;">
                                            <p style=" margin: 0;font-size: 12px;color: #71717a;line-height: 1.6;">
                                                Only share this code in-person when your delivery partner physically arrives with your food.
                                            </p>
                                        </td>
                                    </tr>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 460px; margin-top: 20px;">
                                    <tr>
                                        <td align="center" style="padding-top: 24px;border-top: 1px solid rgba(255,255,255,0.06);">
                                            <p style="margin: 0 0 10px 0;font-size: 12px;line-height: 1.7;color: #71717a;">
                                                ⚠️ <strong>Security Notice:</strong> This is an automated email. Please <strong>do not reply</strong> directly to this message.
                                            </p>

                                            <p style="margin: 0;font-size: 12px;line-height: 1.7;color: #71717a;">
                                                🔒 Vingo administrators will never call or text you asking for this OTP over the phone.
                                            </p>
                                        </td>
                                    </tr>
                                </table>
