    ...
    <AnimatePresence>
      {totalRestaurants > 0 && (
        <motion.div
          ...
          onClick={onOpen}
          className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-[92%] max-w-sm bg-neutral-900/95 backdrop-blur-md text-white border border-neutral-700/50 rounded-full shadow-2xl shadow-neutral-900/50 p-2 pr-5 flex items-center justify-between cursor-pointer group overflow-hidden"
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h3 className="font-bold text-sm tracking-wide text-neutral-100">
                {totalRestaurants}{" "}
                {totalRestaurants > 1 ? "Restaurants" : "Restaurant"}
              </h3>
