...
const DeliveryBoyDashboard = () => {
  ...
  // Delivery Boy's current coordinates
  ...
  const handleAcceptOrder = (assignmentId) => {
        ...
        <div className="flex flex-col gap-4 w-full mt-2">
          {loadingAssignments ? (
            ...
            availableAssignments.map((assignment, index) => {
              ...
              const totalDistance = (distToShop + distToCustomer).toFixed(1);
                  ...
                  <div className="bg-gray-900 p-4 flex justify-between items-center text-white">
                    ...
                    <div className="text-right flex flex-col items-end">
                      ...
                      <div className="flex items-center gap-1 text-lg font-black bg-gray-800 px-2 py-1 rounded-lg">
                        <FiNavigation className="text-[#E23744]" size={16} />
                        {totalDistance} km
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-1.5 font-medium flex items-center gap-1">
                          <FiNavigation size={12} className="text-gray-300" />{" "}
