...
const MyOrder = () => {
  ...
  const { userData, myOrders, shopInMyCity } = useSelector(
    (state) => state.user,
  );
    ...
    <div className="min-h-screen bg-[#fff9f6]">
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-4 mb-8">
          <button
            onClick={() => navigate("/")}
            className="w-10 h-10 rounded-full bg-white shadow flex items-center justify-center hover:bg-orange-50 transition cursor-pointer"
          >
